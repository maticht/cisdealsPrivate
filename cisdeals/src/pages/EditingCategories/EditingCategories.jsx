...
import Modal from '../addServ/addingServicesList/modalCustomServ';
...
import "../addServ/addingServicesList/addingServicesList.css"
            ...
            <div className="main-container">
                ...
                <div>
                    <div className={'allCategoriesBlock'}>
                        {selectedOption !== "" &&
                            CategoriesJSON.categories.map((option, index, array) => (
                                    ...
                                    <div className={'oneCategoryCheckItem'}
                                        style={{
                                            borderBottom:
                                                ...
                                                ? "#DDDDDD solid 1px" : "#DDDDDD solid 1px",
                                        }}
...
export default EditingCategories;
