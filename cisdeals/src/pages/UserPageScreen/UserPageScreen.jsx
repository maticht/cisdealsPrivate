                                ...
                                <div style={{
                                    ...
                                    <Link onClick={() => {
                                        ...
                                        setTimeout(() => {
                                          ...
                                          to={`/AllCategories/Categories2/Categories3/Categories4/Все специалисты/${rating.commentatorId}`}>
                                        <p style={{
                                            margin: '0px',
                                            fontWeight: '500',
                                            color: '#000'
                                    ...
                                    <div style={{display: 'flex', flexDirection: 'row'}}>
                                        {rating.value >= 1 &&
                                            <img src={Star2} alt="Star" style={{marginRight: '5px', width: '18px'}}/>}
                                        {rating.value >= 2 &&
                                            <img src={Star2} alt="Star" style={{marginRight: '5px', width: '18px'}}/>}
                                        {rating.value >= 3 &&
                                            <img src={Star2} alt="Star" style={{marginRight: '5px', width: '18px'}}/>}
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div>
                                    ...
                                    <img onClick={() => handleRate(5)} style={{}} src={rating >= 5 ? Star2 : Star}
                                         alt={'Star'}/>
                                </div>
                            </div>
                            <div>
