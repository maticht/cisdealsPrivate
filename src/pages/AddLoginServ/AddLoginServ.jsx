    ...
    return (
        <div className={styles.signup_container} style={{zIndex:1, minHeight:'100vh'}}>
            <div style={{ width: "94%", height: "3px", background: "#fff", borderRadius:'5px', margin:'10px', alignSelf:'center' }}>
                <div id="progressBar" style={{ width: `75%`, height: "3px",transition: 'width 1s ease-in-out', background: "#5CA91A", borderRadius:'5px' }}></div>
            </div>
            <Link style={{textDecoration: "none", color: "#454545", fontSize: "14px"}} to={`/AddDescription/${UserPage}`}>
            ...
            <div className={styles.form_container} noValidate>
                <div style={{justifyContent:"flex-start", backgroundColor:"#fff",borderRadius:8, margin:"10px 11px", padding:"15px 10px 5px 10px"}}>
                    <div style={{display: serv.length === 0 ? 'none' : null, marginBottom:'-10px'}}>
                        <div style={{ flexDirection:'column', backgroundColor:"#fff", display:"flex", alignSelf:"center", justifyContent:"center", alignItems:'flex-start', borderRadius:8}}>
                            <div style={{width:'100%'}}>
                                {Object.entries(
                                    serv.reduce((acc, obj) => {
                                    ...
                                    <div key={parent} style={{width:'100%', marginBottom:'35px'}}>
                                        ...
                                        {data.map((obj) => (
                                            ...
                                            <div key={obj.title} style={{margin:'-5px 0 5px 0', width:'100%'}}>
                                                <div className={classes.OneUnderCategoryCheckItem} style={{width:'100%',height:'50px',display:'flex', flexDirection:'row', justifyContent:'flex-start',alignItems:'center', marginLeft:'0',padding: "0",}}>
                                                    <div style={{display:'flex', flexDirection:'row', alignItems:'center'}}>
                                                        <img style={{margin:'2px 5px 0 0', width:'12px'}} onClick={() => handleDeleteClick(obj._id)} src={xMark}/>
                                                    </div>
                                                    <Link style={{textDecoration:'none', display:'flex',width:'100%', flexDirection:'row', alignItems:'center', justifyContent:'space-between'}} to={`/AddLoginServ/${UserPage}/UserServLoginScreen/${obj._id}`}>
                                                        ...
                                                        <div style={{display:'flex', flexDirection:'row', alignItems:'center'}}>
                                                            ...
                                                            <img style={{marginTop:'5px', width:'12px', rotate:"-90deg"}} src={arrowDown}/>
                                                        </div>
                                                ...
                                                {deleteModal && deleteObjId === obj._id && (
                                                    ...
                                                    >
                                                        <div style={{ width: "300px", backgroundColor: "#fff", borderRadius:'10px', display:'flex', flexDirection:'column', padding:'15px 10px' }}>
                                                            <p style={{margin:'0'}}>Вы уверены, что хотите удалить услугу <p style={{fontWeight:'500', margin:'0'}}>{`“${obj.title}”`}</p></p>
                                                            <div style={{display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'space-between', marginTop:'20px'}}>
                                                                <div style={{width:'142px', height:'45px', backgroundColor:'#000', borderRadius:'8px',display:'flex', justifyContent:'center', alignItems:'center', paddingBottom:'2px'}} onClick={() => setDeleteModal(false)}>
                                                                    <p style={{color:'#fff', fontWeight:'600'}}>Не удалять</p>
                                                                </div>
                                                                <div style={{width:'142px', height:'45px', backgroundColor:'#fff', borderRadius:'8px', border:'#000 solid 2px',display:'flex', justifyContent:'center', alignItems:'center', paddingBottom:'2px'}} onClick={() => servDelete(deleteObjId)}>
                                                                    <p style={{color:'#000', fontWeight:'600'}}>Удалить</p>
                                                                </div>
                                                            </div>
                    ...
                    <button className={styles.inputBtn} style={{backgroundColor: '#ffffff',marginTop:'-10px'}} onClick={handleOpenServModal} >
                                    ...
                                    <div>
                                        ...
                                        <div style={{display:'flex', flexDirection:'row', flexWrap:'wrap', alignItems:'center', justifyContent:'flex-start'}}>
                                            {selectedServices.map((service) => (
                                                <div style={{display:'flex', flexDirection:'row', padding:'1px 6px', alignItems:'center', justifyContent:'space-between', border:" #5CA91A solid 2px", borderRadius:'9px', margin:'0 6px 6px 0'}} key={`${service.title}-${service.parent}`}>
                                                    <p style={{color:'#5CA91A', margin:'2px 0 5px 1px', fontSize:'14px'}}>{service.title}</p>
                                                    <img style={{margin:'1px 0 0 5px'}} src={greenxMark} onClick={() => handleRemoveService(service.title, service.parent)}></img>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                            ...
                                            CategoriesJSON.categories.filter(category => selectedOption.includes(category.categoriestitle)).map((option, index, array) => (
                                                <div
                                                    ...
                                                    >
                                                        ...
                                                        <img style={{marginTop:'5px'}} src={selectedCategory === option.categoriestitle ? arrowUp : arrowDown}/>
                                                    </div>
                                                                        ...
                                                                        {opt.subsubcategories.length === 0 ? (
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <img style={{marginTop:'5px'}} src={selectedDownCategory === opt.title ? arrowUp : arrowDown}/>
                                                                                </div>
            ...
            <Link to={`/AddImage/${UserPage}`} style={{alignSelf:'center'}}>
                <button className={styles.green_btn} style={{width:'180px'}}>
                    Дбавить
                </button>
            </Link>
