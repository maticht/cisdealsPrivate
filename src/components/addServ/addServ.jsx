                                            ...
                                            {data.map((obj) => (
                                                    ...
                                                    <div key={obj.title} style={{margin:'-5px 0 5px 0', width:'100%'}}>
                                                        <div className={classes.OneUnderCategoryCheckItem} style={{width:'100%',height:'50px',display:'flex', flexDirection:'row', justifyContent:'flex-start',alignItems:'center', marginLeft:'0',padding: "0",}}>
                                                            ...
                                                            <Link style={{textDecoration:'none', display:'flex',width:'100%', flexDirection:'row', alignItems:'center', justifyContent:'space-between'}} to={`/addServ/${UserPage}/UserServScreen/${obj._id}`}>
