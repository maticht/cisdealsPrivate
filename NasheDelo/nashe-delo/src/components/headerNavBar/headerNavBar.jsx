...
import logo from '../../img/nasheDeloLogo.svg';
...
function HeaderNavBar() {
    ...
    return (
        <div className={'navBarBlock'}>
            <Link href={"/"}>
                <Image src={logo} className={"App-nav-logo"} alt={"logo"}/>
            </Link>
            ...
            {!modalOpen && (
                <div className={'accountBtnBlock'}>
                    {user ? (
                        <div>
                            <Link href={`/PersonalUserPage/${userid}`} className={"logOutBlock"}>
                        ...
                        <Link className={"logInBlock"} href={"/login"}>
